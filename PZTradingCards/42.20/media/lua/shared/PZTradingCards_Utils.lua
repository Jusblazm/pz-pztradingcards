...
local PZTradingCards_ServerTranslations = require("PZTradingCards_ServerTranslations")
...
PZTradingCards_Utils.validTradingCards = {
    ...
    ["Base.PZTradingCardBloodshedFullFoil"] = true,
...
function PZTradingCards_Utils.setCardName(item)
    ...
    local translatedName = PZTradingCards_ServerTranslations.get(key)
